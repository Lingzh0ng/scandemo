...
public class AddDeviceFragment extends BaseMvpFragment {
  ...
  @BindView(R.id.cellDeviceNo) CustomEditCell cellDeviceNo;
  @BindView(R.id.cellDevicePin) CustomEditCell cellDevicePin;
  ...
  @Override public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    adapter = new DeviceManangerRecyclerViewAdapter(devices,
        new DeviceManangerRecyclerViewAdapter.OnListFragmentInteractionListener() {
          @Override public void onListFragmentInteraction(Device item) {
            devices.remove(item);
  ...
  @OnClick(R.id.btnAdd) public void onViewClicked() {
