...
import com.wearapay.scandemo.module.user.presenter.UserInfoPresenter;
...
public class UserInfoFragment extends BaseMvpFragment implements IUserInfoView{
  @BindView(R.id.cellBanlace) CustomLabelCell cellBanlace;
  @BindView(R.id.cellFeng) CustomLabelCell cellFeng;
  @BindView(R.id.bntCharge) Button bntCharge;
  @BindView(R.id.bntPwd) Button bntPwd;
  @BindView(R.id.btnInfo) Button btnInfo;
  @BindView(R.id.cellDeviceNo) CustomLabelCell cellDeviceNo;
  @BindView(R.id.btnDeviceManage) Button btnDeviceManage;
  ...
  @Override protected BaseFragmentPresenter[] initPresenters() {
    return new BaseFragmentPresenter[] {userInfoPresenter};
  }
