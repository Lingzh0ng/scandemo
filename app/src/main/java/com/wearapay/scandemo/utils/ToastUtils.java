...
public final class ToastUtils {
  ...
  private static int yOffset =
      (int) (64 * App.app.getResources().getDisplayMetrics().density + 0.5);
  @SuppressLint("StaticFieldLeak") private static View customView;
  ...
  public static void setView(@LayoutRes int layoutId) {
    LayoutInflater inflate =
        (LayoutInflater) App.app.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
